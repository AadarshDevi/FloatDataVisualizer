...
2. Download Latest for your platform and Unzip it. (There is only Windows)
3. Go into the extracted folder till you find `.msi`
4. Double click `.msi`
...
6. If there is a Serial Comm Port connected to your PC, the terminal will show up and print data and values.
   > Before running the Data Receiver, make sure the data is tailored toward your team
   in [settings.txt](Settings.md)<br>
