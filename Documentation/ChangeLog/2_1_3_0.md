...
During startup, the app will show the filepath of the settings.txt / config file.
...
2. View
    1. Scatterplot
        ...
        4. Decrease Width
    2. Table
        1. Increase Height (disabled)
        2. Decrease Height (disabled)
3. Export
    1. Screenshot
        1. Scatterplot
        2. Table
...
#### New UI Class: data.util.CopyStage

This class will have text on it and will be used to copy the text.
...
5. If the app is being used for the first time, the app will show a dialog box for the settings file.
