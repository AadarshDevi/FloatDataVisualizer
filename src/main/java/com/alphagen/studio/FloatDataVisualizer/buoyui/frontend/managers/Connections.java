    ...
    public static class Processor {
        ...
        public static ConnectionConfig readConnectionConfig(Properties properties) {
            try {
                ...
                System.out.println(properties.getProperty("connection_port"));
                ...
                return ConnectionConfig.builder()
                        ...
                        .floatConfig(Parser.parseFloatConfig(properties))
                        .measurementConfigs(Parser.parseMeasurementConfigs(properties))
                        .build();
...
//
//		// fixme: write a new rename function
